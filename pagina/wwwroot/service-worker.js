import { config as unoConfig } from "/package_00f005704e6cfe47350c84bd4dd79747c93cfe53/uno-config.js";
...
if (unoConfig.environmentVariables["UNO_BOOTSTRAP_DEBUGGER_ENABLED"] !== "True") {
    ...
    self.addEventListener('install', function (e) {
        ...
        e.waitUntil(
            caches.open('402ae168-9365-44fc-b9d7-203dbb8c5d7e').then(async function (cache) {
