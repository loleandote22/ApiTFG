        ...
        (function (Xaml) {
            ...
            (function (Controls) {
                class WebView {
                    ...
                    static setBackground(htmlId, color) {
            ...
            (function (Skia) {
                ...
                class BrowserPointerInputSource {
                    ...
                    onPointerEventReceived(evt) {
                        ...
                        BrowserPointerInputSource._exports.OnNativeEvent(this._source, event, //byte @event, // ONE of NativePointerEvent
        ...
        (function (Runtime) {
            ...
            (function (Skia) {
                class BrowserRenderer {
                    ...
                    static setContinousRender(instance, enabled) {
...
(function (Uno) {
    ...
    (function (UI) {
        ...
        (function (Runtime) {
            ...
            (function (Skia) {
                class ImageLoader {
                    static async loadFromArray(array) {
